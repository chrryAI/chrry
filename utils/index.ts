...
export const CHRRY_URL =
  process.env.NEXT_PUBLIC_CHRRY_URL || "https://askvex.com"
...
export const PROD_FRONTEND_URL = chrryUrl
...
export const isCollaborator = (
  thread:
    | thread
    | {
        collaborations?: { user: user; collaboration: collaboration }[] | null
      },
  userId?: string,
