        ...
        <>
          ...
          >
            <div className={styles.menuItems}>
              ...
              <a
                href={isStandalone ? undefined : `${FRONTEND_URL}/threads`}
                onClick={(e) => {
                  track({
                  ...
                  {isLoadingThreads ? (
                    ...
                    <>
                      ...
                      {threads.threads.length
                        ? (() => {
                            const url = profile
                              ? `/u/${profile.userName}${collaborationStatus ? `?collaborationStatus=${collaborationStatus}` : ""}`
                              : `${slug?.toLowerCase() ? `/${slug.toLowerCase()}` : ""}/threads${collaborationStatus ? `?collaborationStatus=${collaborationStatus}` : ""}`
                            return (
          ...
          >
            ...
            <div className={styles.bottom}>
              <a
                ...
                href={`https://focusbutton.com${language === defaultLocale ? "" : `/${language}`}`}
                style={{
                  display: "inline-flex",
                  alignItems: "center",
              ...
              >
                <Img
                  width={18}
                  height={18}
                  src={`${FRONTEND_URL}/images/focusbutton.png`}
                  alt=""
                />
                FocusButton
              </a>
